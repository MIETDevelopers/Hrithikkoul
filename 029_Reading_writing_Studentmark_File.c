...
int main() {//start of main function body
    ...
    fptr=fopen("D:\\Hrithikkoul_117_C_Programs_Repository\\Reading_writing_Studentmark_File.txt","wb"); //Opening the file from the location.
    ...
    fclose(fptr);
    fptr=fopen("D:\\Hrithikkoul_117_C_Programs_Repository\\Reading_writing_Studentmark_File.txt","rb");
