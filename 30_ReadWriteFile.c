...
struct s {//start of structure body
 ...
 int main(){//start of main body
	...
	fptr=fopen("D:\\Hrithikkoul_117_C_Programs_Repository\\Read_Write_File.txt","wb"); //Opening the file from the location.
	...
	fclose(fptr);
	fptr=fopen("D:\\Hrithikkoul_117_C_Programs_Repository\\Read_Write_File.txt","rb");
